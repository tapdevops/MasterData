...
# if you need a build script, uncomment the line below
 RUN echo 'sh mybuild.sh' >> /usr/bin/start.sh 415e13afc7ff
...
RUN echo 'echo will install crond...' >> /usr/bin/start.sh 415e13afc7ff
RUN echo 'crond' >> /usr/bin/start.sh 415e13afc7ff
